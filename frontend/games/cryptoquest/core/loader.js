async function loadCanonicalRuntime() {
  ...
  if (!html.includes('/games/cryptoquest/v34-cinematic-runtime.js?v=34.2.1')) {
    html = html.replace('</body>', '<script src="/games/cryptoquest/v34-cinematic-runtime.js?v=34.2.1" defer></script></body>');
  }
