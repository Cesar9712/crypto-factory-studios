async function loadCanonicalRuntime() {
  ...
  if (!html.includes('/games/cryptoquest/v34-cinematic-anime.css?v=34.0.0')) {
    html = html.replace('</head>', '<link rel="stylesheet" href="/games/cryptoquest/v34-cinematic-anime.css?v=34.0.0"><meta name="cryptoquest-cinematic" content="V34-CINEMATIC-ANIME"></head>');
  }
