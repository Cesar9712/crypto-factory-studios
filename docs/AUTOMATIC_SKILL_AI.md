...
The selector evaluates player HP, enemy HP, mana, skill cost, cooldowns, boss status, tactic, skill role, execution thresholds, armor piercing, critical modifiers and damage reduction.
