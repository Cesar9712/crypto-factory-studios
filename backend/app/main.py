...
app=FastAPI(title='Crypto Factory Studios API',version='0.7.1')
...
@app.get('/health')
def health(): return {'ok':True,'service':'crypto-factory-studios','version':'0.7.1','git_commit':os.getenv('RENDER_GIT_COMMIT','')}
@app.get('/ready')
def ready():
