...
class Settings:
    ...
    tron_deposit_addresses: tuple[str,...] = field(default_factory=lambda: _csv_env('CFS_TRON_DEPOSIT_ADDRESSES') or ('TSBJBbqZPz2vg4cmtTKAX7ZVwxvjUzwDHR','TQRXBazP13v2iYSmqVjf6sytfr1CRnmN78'))
    bsc_deposit_addresses: tuple[str,...] = field(default_factory=lambda: _csv_env('CFS_BSC_DEPOSIT_ADDRESSES') or ('0x48D86139Dd8229CA97e4Cb9509347D823e859ef9','0xD32896D46E6B3F0aeEA4F4d8a8152E3665E9121E'))
